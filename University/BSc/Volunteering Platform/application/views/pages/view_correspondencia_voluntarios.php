...
<div class="row">
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse sidebar-navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>index.php/correspondencias" class="active">Voluntarios <span class="badge"><?php echo $numCorrs; ?></span></a></li>
    ...
    <div class="col-sm-9">
        <div class="container">
            <h3>Lista de volunt&aacute;rios correspondidos</h3>
            <hr>
            <div class="row">
	        	<div class="col-md-12">
	            	<form action="" class="search-form">
	                	<div class="form-group has-feedback">
	            			...
	            			<input type="text" class="form-control" name="search" id="search" 
	            					placeholder="Procurar voluntario">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <?php foreach( $voluntarios as $data ) { ?>
                        <tr>
                            <td><?php echo $data["NOME"]; ?></td>
                            <td><?php echo $data["EMAIL"]; ?></td>
                            <td><?php echo $data["OPORTUNIDADE"] ?></td>
                            <td>
                                <?php
                                // localidade check?
                                if ( $data["ID_DISTRITO"] && $data["ID_CONCELHO"] && $data["ID_FREGUESIA"] ) 
                                {
                                    echo "<span class=\"glyphicon glyphicon-home\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Localidade\"></span>";
                                }
                                else if ( $data["ID_DISTRITO"] && $data["ID_CONCELHO"] )
                                {
                                ...
                                ?>
                                <a href="<?php echo base_url(); ?>index.php/Correspondencias/voluntario/<?php echo $data['url']; ?>">
